        ...
        <div className="space-y-6 text-sm text-gray-700">
          <div className="mb-6">
            <p className="mb-4">
              ...
              서비스 '어디가냥? 같이가개!'(이하 '서비스')의 이용과 관련하여,
              회사와 이용자 간 권리, 의무 및 책임사항, 기타 필요한 사항을
              규정함을 목적으로 합니다.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="mb-2">
              이 약관은 서비스 제공자인 SWYP 웹기획 10팀(이하 '회사')이 제공하는
              반려동물 동반 장소 검색 및 추천 서비스와 관련하여 회사와 이용자
          ...
          <div>
            ...
            <ul className="list-disc list-inside space-y-1 ml-4">
              <li>
                '서비스'란 회사가 제공하는 반려동물과 함께 방문할 수 있는 장소에
                대한 정보 검색, 리뷰, 추천 등의 기능을 의미합니다.
              </li>
              <li>
              ...
              <li>
                '회원'이란 소셜 로그인을 통해 서비스를 이용하는 자로서, 회사가
                정한 절차에 따라 개인정보를 제공하고 본 약관에 동의하여 가입한
                자를 의미합니다.
              </li>
              <li>
                '게시물'이란 이용자가 서비스를 통해 작성한 글, 리뷰, 이미지 등을
                의미합니다.
              </li>
            </ul>
          </div>
