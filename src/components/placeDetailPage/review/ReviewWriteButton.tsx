...
const ReviewWriteButton = ({ id }: Props) => {
  ...
  return (
    <div className="relative inset-0 w-full h-[212px]">
      ...
      />
      <button
        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[514px] h-[56px] z-10 bg-[var(--main-color)] text-[var(--main-text)] rounded-[16px] cursor-pointer transition hover:brightness-85"
        onClick={() => {
          isLoggedIn
